...
shader_color_pos_lum::shader_color_pos_lum(const utki::shared_ref<const ruis::render::context>& rendering_context) :
	ruis::render::coloring_shader(rendering_context),
	shader_base(
		R"qwertyuiop(
			attribute vec4 a0;
			attribute float a1;
